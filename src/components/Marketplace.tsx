...
const Marketplace = () => {
  ...
  const previewListings = [
    {
      ...
      name: "Bloo Bonkee",
      image:
        "https://cdn.chatandbuild.com/users/689bee88f300c9caf5f9881e/bloo-bonkee-1755298715025-223344300.jpeg",
      price: "0.8 SOL",
      bnkzPrice: "720 BNKZ",
      rarity: "Rare",
      totalSupply: 500,
    ...
    },
    {
      ...
      name: "Yelloo Bonkee",
      image:
        "https://cdn.chatandbuild.com/users/689bee88f300c9caf5f9881e/yelloo-bonkee-1755298146545-396548464.jpeg",
      price: "0.5 SOL",
      bnkzPrice: "450 BNKZ",
      rarity: "Common",
      totalSupply: 2000,
    ...
    },
    {
      ...
      name: "Redz Bonkee",
      image:
        "https://cdn.chatandbuild.com/users/689bee88f300c9caf5f9881e/redz-1755298949640-153157693.jpeg",
      price: "1.2 SOL",
    ...
    },
    {
      ...
      name: "Pinko Bonkee",
      image:
        "https://cdn.chatandbuild.com/users/689bee88f300c9caf5f9881e/image-1755299183632-281941757.jpg",
      price: "0.4 SOL",
      bnkzPrice: "360 BNKZ",
      rarity: "Common",
      totalSupply: 2000,
    ...
    },
    {
      ...
      name: "Purpo Bonkee",
      image:
        "https://cdn.chatandbuild.com/users/689bee88f300c9caf5f9881e/purpo-bonkee-1755299353407-767500589.jpeg",
      price: "0.9 SOL",
      bnkzPrice: "810 BNKZ",
      rarity: "Ultra Rare",
      totalSupply: 250,
    ...
    },
    {
      ...
      name: "Greeno Bonkee",
      image:
        "https://cdn.chatandbuild.com/users/689bee88f300c9caf5f9881e/greeno-bonkee-1755299593663-446736790.jpeg",
      price: "0.7 SOL",
      bnkzPrice: "630 BNKZ",
      rarity: "Rare",
      totalSupply: 500,
  ...
  const filteredListings = previewListings.filter(
    (listing) =>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Preview the upcoming Bonkeez collection. Launch pricing with 10%
            discount available with $BNKZ tokens.
          </p>
        </div>
        ...
        <div className="bg-emerald-400/10 border border-emerald-400/20 rounded-2xl p-6 mb-8 text-center">
          ...
          <p className="text-slate-300">
            All NFTs will be available for minting at launch. No items have been
            minted yet.
          </p>
        </div>
        ...
        >
          {filteredListings.map((listing) => (
            <div
              key={listing.id}
              className={`bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all group cursor-pointer ${
            ...
            >
              ...
              >
                ...
                <div className="absolute top-2 right-2 flex flex-col space-y-1">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-bold ${getRarityColor(listing.rarity)}`}
                  >
                    {listing.rarity}
                  </span>
                    ...
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-emerald-400 font-medium">
                          {listing.totalSupply.toLocaleString()}
                        </p>
                      </div>
                      <div className="text-right">
                    ...
                    <div className="bg-white/5 rounded-xl p-3 mb-4 border border-white/10">
                      ...
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <span className="text-emerald-400">
                          {listing.totalSupply.toLocaleString()} available
                        </span>
                      </div>
                    </div>
        ...
        {filteredListings.length === 0 && (
          <div className="text-center py-12">
            <p className="text-slate-400 text-lg mb-4">
              No Bonkeez found matching your search.
            </p>
            <button
        ...
        <div className="text-center mt-12">
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 max-w-2xl mx-auto">
            ...
            <p className="text-slate-300 mb-6">
              All 5,350 Bonkeez NFTs will be available for minting at launch. Be
              ready to secure your favorite characters!
            </p>
            <button
