...
const Hero = () => {
  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/20 via-transparent to-green-400/20"></div>
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-pink-400/15 rounded-full blur-3xl"></div>
